...
ISEQ_FLIP_CNT_INCREMENT(rb_iseq_t *iseq)
{
...
static inline void
ISEQ_ORIGINAL_ISEQ_CLEAR(rb_iseq_t *iseq)
{
...
static inline VALUE *
ISEQ_ORIGINAL_ISEQ_ALLOC(rb_iseq_t *iseq, long size)
{
    return iseq->body.variable.original_iseq =
        ALLOC_N(VALUE, size);
}
...
void rb_iseq_constant_body_init(struct rb_iseq_constant_body *iseq_body);
